...
begin
  ...
  case ATestNum of
    ...
    13: LTestName := 'test_program_math';
    14: LTestName := 'test_program_conversion';
    15: LTestName := 'test_program_memory';
    16: LTestName := 'test_program_string2';
    17: LTestName := 'test_program_fileio2';
    18: LTestName := 'test_program_fileio3';
  else
    LTestName := '';
  end;
